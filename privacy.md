...
- Paper information is extracted from webpages and saved directly to YOUR Google Sheets
- Your reading notes and status are stored in YOUR Google Sheets
- We never see, access, or store any of your data on our servers
...
### DATA SECURITY
Since we don't collect or store your data, there is no central database to breach. Your data security depends on your Google account security. We recommend using strong passwords and two-factor authentication.
