...
How It Works
1. Open an academic article webpage
2. Click the extension
3. Article metadata is extracted
4. Add notes or reading status
5. Click save - your notes and article information are saved to a Google Sheet
Each paper becomes a structured row you can revisit anytime.
What It Captures
Automatically extracts:
Title, authors, journal/source, year, DOI, URL, abstract
You can add:
Reading status (read / skimmed / want to read)
Personal notes
Importance flag
...
Your reading log lives entirely in your Google account.

Pricing: Free to save up to 25 papers, then a one-time $5 purchase for unlimited logging.
